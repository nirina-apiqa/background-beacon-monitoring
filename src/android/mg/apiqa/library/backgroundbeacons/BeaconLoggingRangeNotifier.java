...
public class BeaconLoggingRangeNotifier implements RangeNotifier {
  ...
  public void didRangeBeaconsInRegion(Collection<Beacon> beacons, Region region) {
    ...
    Log.d("mg.apiqa.library.backgroundbeacons", "didRangeBeaconsInRegion called");
    ...
    for (Beacon beacon: beacons) {
      Log.d("mg.apiqa.library.backgroundbeacons", "I see beacon " + beacon);
      ...
      Log.d("mg.apiqa.library.backgroundbeacons", beaconTrackingEvent.toJsonObject().toString());
